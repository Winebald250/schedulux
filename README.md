...
[docspot](https://github.com/Winebald250/schedulux.git) is a Simple web project that is made for e-channeling Using PHP,HTML & CSS.
...
| -------| -------| -------|                                                    
| Email: `admin@schedulux.com` | Email: `doctor@schedulux.com` |   Email: `patient@schedulux.com` | 
...
7. Browse the Doctor's Appointment Systsem in a browser. i.e. http://localhost/docspot.
